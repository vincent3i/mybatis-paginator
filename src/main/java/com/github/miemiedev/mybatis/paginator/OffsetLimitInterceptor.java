...
public class OffsetLimitInterceptor implements Interceptor {
	...
	public Object intercept(final Invocation invocation) throws Throwable {
		...
		try {
			...
			Constructor<? extends Dialect> constructor = clazz.getConstructor(MappedStatement.class, Object.class, PageBounds.class);
			dialect = constructor.newInstance(new Object[] { ms, parameter, pageBounds });
		} catch (Exception e) {
